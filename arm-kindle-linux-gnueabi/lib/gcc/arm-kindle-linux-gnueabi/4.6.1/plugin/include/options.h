...
enum opt_code
{
  ...
  OPT_fconstexpr_depth_ = 464,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 465,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 466,          /* -fconvert=little-endian */
  OPT_fconvert_native = 467,                 /* -fconvert=native */
  OPT_fconvert_swap = 468,                   /* -fconvert=swap */
  OPT_fcprop_registers = 469,                /* -fcprop-registers */
  OPT_fcray_pointer = 470,                   /* -fcray-pointer */
  OPT_fcrossjumping = 471,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 472,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 473, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 474,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 475,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 476,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 477,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 478,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 479,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 480,                       /* -fdbg-cnt= */
  OPT_fdce = 481,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 482,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 483,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 484,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 485, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 486,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 487,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 488,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 489,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 490,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 491,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 492,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 493,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 494,                /* -fdirectives-only */
  OPT_fdisable_assertions = 495,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 496,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 497,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 498,         /* -fdollars-in-identifiers */
  OPT_fdse = 499,                            /* -fdse */
  OPT_fdump_ = 500,                          /* -fdump- */
  OPT_fdump_core = 501,                      /* -fdump-core */
  OPT_fdump_final_insns = 502,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 503,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 504,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 505,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 506,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 507,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 508,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 509,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 510,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 511,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 512,                 /* -fearly-inlining */
  OPT_felide_constructors = 513,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 514,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 515, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 516,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 517,        /* -femit-class-debug-always */
  OPT_femit_class_file = 518,                /* -femit-class-file */
  OPT_femit_class_files = 519,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 520,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 521,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 522,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 523,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 524,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 525,               /* -fenable-icf-debug */
  OPT_fencoding_ = 526,                      /* -fencoding= */
  ...
  OPT_fextdirs_ = 533,                       /* -fextdirs= */
  OPT_fextended_identifiers = 534,           /* -fextended-identifiers */
  OPT_fexternal_blas = 535,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 536, */       /* -fexternal-templates */
  OPT_ff2c = 537,                            /* -ff2c */
  OPT_ffast_math = 538,                      /* -ffast-math */
  OPT_ffilelist_file = 539,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 540,               /* -ffinite-math-only */
  OPT_ffixed_ = 541,                         /* -ffixed- */
  OPT_ffixed_form = 542,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 543,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 544,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 545,                    /* -ffloat-store */
  OPT_ffor_scope = 546,                      /* -ffor-scope */
  /* OPT_fforce_addr = 547, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 548,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 549,              /* -fforward-propagate */
  OPT_ffp_contract_ = 550,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 551,                      /* -ffpe-trap= */
  OPT_ffree_form = 552,                      /* -ffree-form */
  OPT_ffree_line_length_ = 553,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 554,          /* -ffree-line-length-none */
  OPT_ffreestanding = 555,                   /* -ffreestanding */
  OPT_ffriend_injection = 556,               /* -ffriend-injection */
  OPT_ffunction_cse = 557,                   /* -ffunction-cse */
  OPT_ffunction_sections = 558,              /* -ffunction-sections */
  OPT_fgcse = 559,                           /* -fgcse */
  OPT_fgcse_after_reload = 560,              /* -fgcse-after-reload */
  OPT_fgcse_las = 561,                       /* -fgcse-las */
  OPT_fgcse_lm = 562,                        /* -fgcse-lm */
  OPT_fgcse_sm = 563,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 564,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 565,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 566,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 567,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 568,                     /* -fgo-prefix= */
  OPT_fgraphite = 569,                       /* -fgraphite */
  OPT_fgraphite_identity = 570,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 571,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 572, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 573, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 574,           /* -fhash-synchronization */
  /* OPT_fhelp = 575, */                     /* -fhelp */
  /* OPT_fhelp_ = 576, */                    /* -fhelp= */
  /* OPT_fhonor_std = 577, */                /* -fhonor-std */
  OPT_fhosted = 578,                         /* -fhosted */
  /* OPT_fhuge_objects = 579, */             /* -fhuge-objects */
  OPT_fident = 580,                          /* -fident */
  OPT_fif_conversion = 581,                  /* -fif-conversion */
  OPT_fif_conversion2 = 582,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 583,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 584,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 585,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 586,             /* -fimplicit-templates */
  OPT_findirect_classes = 587,               /* -findirect-classes */
  OPT_findirect_dispatch = 588,              /* -findirect-dispatch */
  OPT_findirect_inlining = 589,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 590,         /* -finhibit-size-directive */
  OPT_finit_character_ = 591,                /* -finit-character= */
  OPT_finit_integer_ = 592,                  /* -finit-integer= */
  OPT_finit_local_zero = 593,                /* -finit-local-zero */
  OPT_finit_logical_ = 594,                  /* -finit-logical= */
  OPT_finit_real_ = 595,                     /* -finit-real= */
  OPT_finline = 596,                         /* -finline */
  OPT_finline_functions = 597,               /* -finline-functions */
  OPT_finline_functions_called_once = 598,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 599, */            /* -finline-limit- */
  OPT_finline_limit_ = 600,                  /* -finline-limit= */
  OPT_finline_small_functions = 601,         /* -finline-small-functions */
  OPT_finput_charset_ = 602,                 /* -finput-charset= */
  OPT_finstrument_functions = 603,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 604,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 605,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 606,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 607,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 608,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 609,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 610,                    /* -fipa-profile */
  OPT_fipa_pta = 611,                        /* -fipa-pta */
  OPT_fipa_pure_const = 612,                 /* -fipa-pure-const */
  OPT_fipa_reference = 613,                  /* -fipa-reference */
  OPT_fipa_sra = 614,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 615,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 616,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 617,              /* -fira-loop-pressure */
  OPT_fira_region_ = 618,                    /* -fira-region= */
  OPT_fira_share_save_slots = 619,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 620,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 621,                   /* -fira-verbose= */
  OPT_fivopts = 622,                         /* -fivopts */
  OPT_fjni = 623,                            /* -fjni */
  OPT_fjump_tables = 624,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 625,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 626,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 627,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 628, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 629,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 630,             /* -fleading-underscore */
  OPT_floop_block = 631,                     /* -floop-block */
  OPT_floop_flatten = 632,                   /* -floop-flatten */
  OPT_floop_interchange = 633,               /* -floop-interchange */
  ...
  OPT_flto = 637,                            /* -flto */
  OPT_flto_compression_level_ = 638,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 639,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 640,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 641,             /* -flto-partition=none */
  OPT_flto_report = 642,                     /* -flto-report */
  OPT_flto_ = 643,                           /* -flto= */
  OPT_fltrans = 644,                         /* -fltrans */
  OPT_fltrans_output_list_ = 645,            /* -fltrans-output-list= */
  OPT_fmain_ = 646,                          /* -fmain= */
  OPT_fmath_errno = 647,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 648,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 649,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 650,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 651,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 652,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 653,                     /* -fmem-report */
  OPT_fmerge_all_constants = 654,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 655,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 656,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 657,                /* -fmessage-length= */
  OPT_fmodule_private = 658,                 /* -fmodule-private */
  OPT_fmodulo_sched = 659,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 660,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 661,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 662,                  /* -fms-extensions */
  OPT_fmudflap = 663,                        /* -fmudflap */
  OPT_fmudflapir = 664,                      /* -fmudflapir */
  OPT_fmudflapth = 665,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 666, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 667, */                  /* -fnew-abi */
  OPT_fnext_runtime = 668,                   /* -fnext-runtime */
  OPT_fnil_receivers = 669,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 670,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 671,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 672, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 673,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 674,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 675,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 676,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 677,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 678,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 679,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 680,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 681,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 682,             /* -fomit-frame-pointer */
  OPT_fopenmp = 683,                         /* -fopenmp */
  OPT_foperator_names = 684,                 /* -foperator-names */
  OPT_foptimize_register_move = 685,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 686,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 687,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 688, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 689,              /* -foutput-class-dir= */
  OPT_fpack_derived = 690,                   /* -fpack-derived */
  OPT_fpack_struct = 691,                    /* -fpack-struct */
  OPT_fpack_struct_ = 692,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 693,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 694,              /* -fpcc-struct-return */
  OPT_fpch_deps = 695,                       /* -fpch-deps */
  OPT_fpch_preprocess = 696,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 697,                     /* -fpeel-loops */
  OPT_fpeephole = 698,                       /* -fpeephole */
  OPT_fpeephole2 = 699,                      /* -fpeephole2 */
  OPT_fpermissive = 700,                     /* -fpermissive */
  OPT_fpic = 701,                            /* -fpic */
  OPT_fpie = 702,                            /* -fpie */
  OPT_fplan9_extensions = 703,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 704,                    /* -fplugin-arg- */
  OPT_fplugin_ = 705,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 706,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 707,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 708,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 709,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 710,                   /* -fpreprocessed */
  OPT_fpretty_templates = 711,               /* -fpretty-templates */
  OPT_fprofile = 712,                        /* -fprofile */
  OPT_fprofile_arcs = 713,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 714,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 715,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 716,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 717,              /* -fprofile-generate= */
  OPT_fprofile_use = 718,                    /* -fprofile-use */
  OPT_fprofile_use_ = 719,                   /* -fprofile-use= */
  OPT_fprofile_values = 720,                 /* -fprofile-values */
  OPT_fprotect_parens = 721,                 /* -fprotect-parens */
  OPT_frandom_seed = 722,                    /* -frandom-seed */
  OPT_frandom_seed_ = 723,                   /* -frandom-seed= */
  OPT_frange_check = 724,                    /* -frange-check */
  OPT_frealloc_lhs = 725,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 726,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 727,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 728,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 729,                /* -frecord-marker=8 */
  OPT_frecursive = 730,                      /* -frecursive */
  OPT_freduced_reflection = 731,             /* -freduced-reflection */
  ...
  OPT_freorder_blocks_and_partition = 736,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 737,              /* -freorder-functions */
  OPT_frepack_arrays = 738,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 739,           /* -freplace-objc-classes */
  OPT_frepo = 740,                           /* -frepo */
  OPT_frequire_return_statement = 741,       /* -frequire-return-statement */
  ...
  OPT_frtti = 747,                           /* -frtti */
  OPT_fsaw_java_file = 748,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 749,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 750,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 751,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 752,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 753,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 754,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 755,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 756,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 757,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 758,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 759,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 760,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 761,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 762,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 763,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 764,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 765,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 766, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 767,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 768,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 769,              /* -fsecond-underscore */
  OPT_fsection_anchors = 770,                /* -fsection-anchors */
  /* OPT_fsee = 771, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 772,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 773,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 774, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 775,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 776,          /* -fselective-scheduling2 */
  OPT_fshort_double = 777,                   /* -fshort-double */
  OPT_fshort_enums = 778,                    /* -fshort-enums */
  OPT_fshort_wchar = 779,                    /* -fshort-wchar */
  OPT_fshow_column = 780,                    /* -fshow-column */
  OPT_fsign_zero = 781,                      /* -fsign-zero */
  OPT_fsignaling_nans = 782,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 783,               /* -fsigned-bitfields */
  OPT_fsigned_char = 784,                    /* -fsigned-char */
  OPT_fsigned_zeros = 785,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 786,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 787,               /* -fsource-filename= */
  OPT_fsource_ = 788,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 789,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 790,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 791,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 792, */                 /* -fsquangle */
  /* OPT_fstack_check = 793, */              /* -fstack-check */
  OPT_fstack_check_ = 794,                   /* -fstack-check= */
  OPT_fstack_limit = 795,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 796,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 797,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 798,                /* -fstack-protector */
  OPT_fstack_protector_all = 799,            /* -fstack-protector-all */
  OPT_fstack_usage = 800,                    /* -fstack-usage */
  OPT_fstats = 801,                          /* -fstats */
  OPT_fstore_check = 802,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 803, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 804,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 805,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 806,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 807, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 808,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 809,                    /* -fsyntax-only */
  OPT_ftabstop_ = 810,                       /* -ftabstop= */
  /* OPT_ftarget_help = 811, */              /* -ftarget-help */
  OPT_ftarget_ = 812,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 813, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 814,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 815,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 816, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 817,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 818,             /* -fthreadsafe-statics */
  OPT_ftime_report = 819,                    /* -ftime-report */
  OPT_ftls_model_ = 820,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 821,               /* -ftoplevel-reorder */
  OPT_ftracer = 822,                         /* -ftracer */
  OPT_ftrapping_math = 823,                  /* -ftrapping-math */
  OPT_ftrapv = 824,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 825,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 826,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 827,                       /* -ftree-ccp */
  OPT_ftree_ch = 828,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 829,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 830,                /* -ftree-copyrename */
  OPT_ftree_cselim = 831,                    /* -ftree-cselim */
  OPT_ftree_dce = 832,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 833,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 834,                       /* -ftree-dse */
  OPT_ftree_forwprop = 835,                  /* -ftree-forwprop */
  OPT_ftree_fre = 836,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 837,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 838,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 839,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 840,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 841,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 842,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 843, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 844,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 845,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 846,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 847,                   /* -ftree-phiprop */
  OPT_ftree_pre = 848,                       /* -ftree-pre */
  OPT_ftree_pta = 849,                       /* -ftree-pta */
  OPT_ftree_reassoc = 850,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 851, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 852,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 853,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 854,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 855,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 856, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 857, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 858,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 859,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 860,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 861,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 862,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 863,                       /* -ftree-vrp */
  OPT_funderscoring = 864,                   /* -funderscoring */
  OPT_funit_at_a_time = 865,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 866,               /* -funroll-all-loops */
  OPT_funroll_loops = 867,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 868,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 869,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 870,             /* -funsigned-bitfields */
  OPT_funsigned_char = 871,                  /* -funsigned-char */
  OPT_funswitch_loops = 872,                 /* -funswitch-loops */
  OPT_funwind_tables = 873,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 874,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 875,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 876,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 877,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 878,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 879,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 880,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 881,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 882,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 883,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 884, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 885,                /* -fvect-cost-model */
  OPT_fverbose_asm = 886,                    /* -fverbose-asm */
  /* OPT_fversion = 887, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 888,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 889,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 890,                    /* -fvisibility= */
  OPT_fvpt = 891,                            /* -fvpt */
  /* OPT_fvtable_gc = 892, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 893, */            /* -fvtable-thunks */
  OPT_fweak = 894,                           /* -fweak */
  OPT_fweb = 895,                            /* -fweb */
  OPT_fwhole_file = 896,                     /* -fwhole-file */
  OPT_fwhole_program = 897,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 898,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 899,              /* -fworking-directory */
  OPT_fwpa = 900,                            /* -fwpa */
  OPT_fwrapv = 901,                          /* -fwrapv */
  /* OPT_fxref = 902, */                     /* -fxref */
  OPT_fzee = 903,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 904,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 905,                      /* -fzero-link */
  OPT_g = 906,                               /* -g */
  OPT_gant = 907,                            /* -gant */
  OPT_gcoff = 908,                           /* -gcoff */
  OPT_gdwarf_ = 909,                         /* -gdwarf- */
  OPT_gen_decls = 910,                       /* -gen-decls */
  OPT_ggdb = 911,                            /* -ggdb */
  OPT_gnat = 912,                            /* -gnat */
  OPT_gnatO = 913,                           /* -gnatO */
  OPT_gno_strict_dwarf = 914,                /* -gno-strict-dwarf */
  OPT_gstabs = 915,                          /* -gstabs */
  OPT_gstabs_ = 916,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 917,                   /* -gstrict-dwarf */
  OPT_gtoggle = 918,                         /* -gtoggle */
  OPT_gvms = 919,                            /* -gvms */
  OPT_gxcoff = 920,                          /* -gxcoff */
  OPT_gxcoff_ = 921,                         /* -gxcoff+ */
  OPT_h = 922,                               /* -h */
  OPT_idirafter = 923,                       /* -idirafter */
  OPT_imacros = 924,                         /* -imacros */
  OPT_imultilib = 925,                       /* -imultilib */
  OPT_include = 926,                         /* -include */
  OPT_iplugindir_ = 927,                     /* -iplugindir= */
  OPT_iprefix = 928,                         /* -iprefix */
  OPT_iquote = 929,                          /* -iquote */
  OPT_isysroot = 930,                        /* -isysroot */
  OPT_isystem = 931,                         /* -isystem */
  OPT_iwithprefix = 932,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 933,               /* -iwithprefixbefore */
  OPT_k8 = 934,                              /* -k8 */
  OPT_l = 935,                               /* -l */
  OPT_lang_asm = 936,                        /* -lang-asm */
  OPT_mabi_ = 937,                           /* -mabi= */
  OPT_mabort_on_noreturn = 938,              /* -mabort-on-noreturn */
  OPT_mandroid = 939,                        /* -mandroid */
  OPT_mapcs = 940,                           /* -mapcs */
  OPT_mapcs_float = 941,                     /* -mapcs-float */
  OPT_mapcs_frame = 942,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 943,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 944,               /* -mapcs-stack-check */
  OPT_march_ = 945,                          /* -march= */
  OPT_marm = 946,                            /* -marm */
  OPT_mbig_endian = 947,                     /* -mbig-endian */
  OPT_mbionic = 948,                         /* -mbionic */
  OPT_mcallee_super_interworking = 949,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 950,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 951,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 952,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 953,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 954,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 955,                   /* -mfp16-format= */
  OPT_mfp_ = 956,                            /* -mfp= */
  OPT_mfpe = 957,                            /* -mfpe */
  OPT_mfpe_ = 958,                           /* -mfpe= */
  OPT_mfpu_ = 959,                           /* -mfpu= */
  OPT_mglibc = 960,                          /* -mglibc */
  OPT_mhard_float = 961,                     /* -mhard-float */
  OPT_mlittle_endian = 962,                  /* -mlittle-endian */
  OPT_mlong_calls = 963,                     /* -mlong-calls */
  OPT_mpic_register_ = 964,                  /* -mpic-register= */
  OPT_mpoke_function_name = 965,             /* -mpoke-function-name */
  OPT_msched_prolog = 966,                   /* -msched-prolog */
  OPT_msingle_pic_base = 967,                /* -msingle-pic-base */
  OPT_msoft_float = 968,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 969,       /* -mstructure-size-boundary= */
  OPT_mthumb = 970,                          /* -mthumb */
  OPT_mthumb_interwork = 971,                /* -mthumb-interwork */
  OPT_mtp_ = 972,                            /* -mtp= */
  OPT_mtpcs_frame = 973,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 974,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 975,                          /* -mtune= */
  OPT_muclibc = 976,                         /* -muclibc */
  OPT_mvectorize_with_neon_quad = 977,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 978,               /* -mword-relocations */
  OPT_mwords_little_endian = 979,            /* -mwords-little-endian */
  OPT_n = 980,                               /* -n */
  OPT_no_canonical_prefixes = 981,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 982,               /* -no-integrated-cpp */
  OPT_nocpp = 983,                           /* -nocpp */
  OPT_nodefaultlibs = 984,                   /* -nodefaultlibs */
  OPT_nostartfiles = 985,                    /* -nostartfiles */
  OPT_nostdinc = 986,                        /* -nostdinc */
  OPT_nostdinc__ = 987,                      /* -nostdinc++ */
  OPT_nostdlib = 988,                        /* -nostdlib */
  OPT_o = 989,                               /* -o */
  OPT_p = 990,                               /* -p */
  OPT_pass_exit_codes = 991,                 /* -pass-exit-codes */
  OPT_pedantic = 992,                        /* -pedantic */
  OPT_pedantic_errors = 993,                 /* -pedantic-errors */
  OPT_pg = 994,                              /* -pg */
  OPT_pie = 995,                             /* -pie */
  OPT_pipe = 996,                            /* -pipe */
  OPT_posix = 997,                           /* -posix */
  OPT_print_file_name_ = 998,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 999,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1000,          /* -print-multi-directory */
  OPT_print_multi_lib = 1001,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1002,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1003,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1004,               /* -print-prog-name= */
  OPT_print_search_dirs = 1005,              /* -print-search-dirs */
  OPT_print_sysroot = 1006,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1007,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1008,                        /* -profile */
  OPT_pthread = 1009,                        /* -pthread */
  OPT_quiet = 1010,                          /* -quiet */
  OPT_r = 1011,                              /* -r */
  OPT_rdynamic = 1012,                       /* -rdynamic */
  OPT_remap = 1013,                          /* -remap */
  OPT_s = 1014,                              /* -s */
  OPT_s_bc_abi = 1015,                       /* -s-bc-abi */
  OPT_save_temps = 1016,                     /* -save-temps */
  OPT_save_temps_ = 1017,                    /* -save-temps= */
  OPT_shared = 1018,                         /* -shared */
  OPT_shared_libgcc = 1019,                  /* -shared-libgcc */
  /* OPT_specs = 1020, */                    /* -specs */
  OPT_specs_ = 1021,                         /* -specs= */
  OPT_static = 1022,                         /* -static */
  OPT_static_libgcc = 1023,                  /* -static-libgcc */
  OPT_static_libgcj = 1024,                  /* -static-libgcj */
  OPT_static_libgfortran = 1025,             /* -static-libgfortran */
  OPT_static_libgo = 1026,                   /* -static-libgo */
  OPT_static_libstdc__ = 1027,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1028, */                /* -std=c++03 */
  OPT_std_c__0x = 1029,                      /* -std=c++0x */
  OPT_std_c__98 = 1030,                      /* -std=c++98 */
  OPT_std_c1x = 1031,                        /* -std=c1x */
  /* OPT_std_c89 = 1032, */                  /* -std=c89 */
  OPT_std_c90 = 1033,                        /* -std=c90 */
  OPT_std_c99 = 1034,                        /* -std=c99 */
  /* OPT_std_c9x = 1035, */                  /* -std=c9x */
  OPT_std_f2003 = 1036,                      /* -std=f2003 */
  OPT_std_f2008 = 1037,                      /* -std=f2008 */
  OPT_std_f95 = 1038,                        /* -std=f95 */
  OPT_std_gnu = 1039,                        /* -std=gnu */
  OPT_std_gnu__0x = 1040,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1041,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1042,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1043, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1044,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1045,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1046, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1047, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1048,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1049, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1050, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1051,                     /* -std=legacy */
  OPT_symbolic = 1052,                       /* -symbolic */
  OPT_t = 1053,                              /* -t */
  OPT_time = 1054,                           /* -time */
  OPT_time_ = 1055,                          /* -time= */
  OPT_tno_android_cc = 1056,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1057,                 /* -tno-android-ld */
  OPT_traditional = 1058,                    /* -traditional */
  OPT_traditional_cpp = 1059,                /* -traditional-cpp */
  OPT_trigraphs = 1060,                      /* -trigraphs */
  OPT_u = 1061,                              /* -u */
  OPT_undef = 1062,                          /* -undef */
  OPT_v = 1063,                              /* -v */
  OPT_version = 1064,                        /* -version */
  OPT_w = 1065,                              /* -w */
  OPT_wrapper = 1066,                        /* -wrapper */
  OPT_x = 1067,                              /* -x */
  OPT_z = 1068,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
